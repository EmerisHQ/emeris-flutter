...
void main() {
  test(
    'Native chain amount should be parsed correctly',
    () {
      ...
      expect(
        parseEmerisAmount(amount, baseDenomText),
        Amount.fromString(parsedAmount),
      );
    },
  );

  test(
    'Pooled chain amount should be parsed correctly',
    () {
